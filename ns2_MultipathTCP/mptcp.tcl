...
#
set tcp0 [new Agent/TCP/FullTcp/Sack1/Multipath]
$tcp0 set window_ 100 
$ns attach-agent $n0_0 $tcp0
set tcp1 [new Agent/TCP/FullTcp/Sack1/Multipath]
...
set sink0 [new Agent/TCP/FullTcp/Sack1/Multipath]
$ns attach-agent $n1_0 $sink0 
set sink1 [new Agent/TCP/FullTcp/Sack1/Multipath]
...
#
set reno0 [new Agent/TCP/FullTcp/Sack1]
$reno0 set window_ 100 
$ns attach-agent $n2 $reno0
set renosink0 [new Agent/TCP/FullTcp/Sack1]
...
# create sack TCP connection
#
set reno1 [new Agent/TCP/FullTcp/Sack1]
$reno1 set window_ 100 
$ns attach-agent $n4 $reno1
set renosink1 [new Agent/TCP/FullTcp/Sack1]
